    ...
    <section id="about" className="py-16">
      <div className="container-custom">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <h2 className="text-3xl font-serif mb-4 opacity-0 animate-fade-up">About</h2>
          </div>
          <div className="md:col-span-2">
            <p className="text-lg mb-4 opacity-0 animate-fade-up animate-delay-100">
            ...
            <p className="text-lg mb-4 opacity-0 animate-fade-up animate-delay-200">
            ...
            <p className="text-lg mb-8 opacity-0 animate-fade-up animate-delay-300">
              Currently, I'm focused on helping companies refine their digital presence through strategic design and development.
            </p>
            
            <h3 className="text-xl font-serif mb-3 opacity-0 animate-fade-up animate-delay-400">Experience</h3>
            <div className="space-y-4 mb-8 opacity-0 animate-fade-up animate-delay-500">
              <div>
            ...
            <h3 className="text-xl font-serif mb-3 opacity-0 animate-fade-up animate-delay-400">Skills</h3>
            <div className="grid grid-cols-2 gap-x-8 gap-y-2 opacity-0 animate-fade-up animate-delay-500">
